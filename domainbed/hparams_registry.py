...
def _hparams(algorithm, dataset, random_state):
    ...
    if "Dropout" in algorithm:
        hparams['KL_Loss'] = (1,1)
        hparams['KL_Loss_weight'] = (1.5,1.5)
        hparams['KL_Loss_T'] = (5,5)
        hparams['layer_wise_prob'] = (0.8,0.8)
        hparams['domain_discriminator_flag'] = (1,1)
        hparams['domain_loss_flag'] = (1,1)
        hparams['discriminator_layers'] = ([1, 2, 3, 4],1)
        hparams['grl'] = (1,1)
        hparams['lambd'] = (0.25,1)
        hparams['drop_percent'] = (0.33,0.33)
        hparams['filter_WRS_flag'] =(1,1)
        hparams['recover_flag'] =(1,1)
    if "V" in algorithm :
        hparams['k'] = (10,10 ** random_state.uniform(0.1, 2))
        hparams['lr2'] = (0.1,10 ** random_state.uniform(0.1, 2))
        hparams['tau'] = (0.1,10 ** random_state.uniform(0.1, 2))
        hparams['alpha'] = (0.1,10 ** random_state.uniform(0.1, 2))
        hparams['loss_name'] =('euclidean_distance_loss1',1)
    if 'select' in algorithm:
        hparams['set_count'] = (10,int(100 ** random_state.uniform(0.1, 2)))
        hparams['selection_rate'] = (0.2,random_state.uniform(0.01, 0.99))
        hparams['per'] = (0,0)
        hparams['recompute_count'] = (0,0)
        hparams['select_name'] = ('conv3','conv3')
        hparams['k'] = (0,0)
        hparams['select'] = ('SPU3','SPU3')
        hparams['swa_start'] = (0,0)
        hparams['swa_freq'] = (0,0)
        hparams['way'] = ('var','var')
        hparams['quantile_threshold'] = (0.75,0.75)
        hparams['warm'] = (20,20)
        hparams['noise_level'] = (0,0)
