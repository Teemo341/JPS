...
import sys
sys.path.append('/home/home_node7/wzb/自己算法/miro-main2')
import torch
import torch.nn as nn
import torchvision.models
import VSSMA
from VSSMA import load_pretrained_vmamba
# from VSSMA import load_pretrained_vmamba
import clip
# print(dir(VSSMA))
...
def get_backbone(name, preserve_readout, pretrained):
    ...
    if name == "resnet18":
        ...
        network = load_pretrained_vmamba(name)
        n_outputs = 1024 # 这个没用，使用vmaba要重新设置它的分类头。
