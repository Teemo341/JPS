...
from torchvision.models.resnet import BasicBlock, Bottleneck,ResNet50_Weights,ResNet18_Weights
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(ResNet50_Weights.IMAGENET1K_V1.url), strict=False)
    return model
